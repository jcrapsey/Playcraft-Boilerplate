...
require.config({
  ...
  shim: {
    ...
    "playcraft/boot": ["playcraft/playcraft", "gamecore/jhashtable", "gamecore/device", "gamecore/perf", "gamecore/linkedlist", "gamecore/hashlist", "gamecore/stacktrace", "gamecore/pooled"],
    "playcraft/input": {
      deps: ["playcraft/boot"],
      exports: "pc.Input"
    },
    ...
    "playcraft/entitylayer": {
      deps: ["playcraft/boot", "playcraft/layer"],
      exports: "pc.EntityLayer"
    },
    "playcraft/tileset": {
      deps: ["playcraft/boot"],
      exports: "pc.TileSet"
    ...
    "playcraft/dataresource": {
      deps: ["playcraft/boot"],
      exports: "pc.DataResource"
    },
    "playcraft/components/component": {
      deps: ["playcraft/boot"],
      exports: "pc.components.Component"
    },
    "playcraft/components/physics": {
      deps: ["playcraft/boot", "playcraft/components/component", "box2dweb"],
      exports: "pc.components.Physics"
    },
    "playcraft/components/alpha": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Alpha"
    },
    "playcraft/components/joint": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Joint"
    },
    "playcraft/components/expiry": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Expiry"
    },
    "playcraft/components/originshifter": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.OriginShifter"
    },
    "playcraft/components/spatial": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Spatial"
    },
    "playcraft/components/overlay": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Overlay"
    },
    "playcraft/components/clip": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Clip"
    },
    "playcraft/components/activator": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Activator"
    },
    "playcraft/components/input": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Input"
    },
    "playcraft/components/fade": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Fade"
    },
    "playcraft/components/rect": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Rect"
    },
    "playcraft/components/text": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Text"
    },
    "playcraft/components/sprite": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Sprite"
    },
    "playcraft/components/layout": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.Layout"
    },
    "playcraft/components/particleemitter": {
      deps: ["playcraft/boot", "playcraft/components/component"],
      exports: "pc.components.ParticleEmitter"
    },
    "playcraft/es/entitymanager": {
      deps: ["playcraft/boot"],
      exports: "pc.EntityManager"
    },
    "playcraft/es/systemmanager": {
      deps: ["playcraft/boot"],
      exports: "pc.SystemManager"
    },
    "playcraft/systems/system": {
      deps: ["playcraft/boot"],
      exports: "pc.systems.System"
    },
    "playcraft/systems/entitysystem": {
      deps: ["playcraft/boot", "playcraft/systems/system"],
      exports: "pc.systems.EntitySystem"
    },
    "playcraft/systems/physics": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Physics"
    },
    "playcraft/systems/effects": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Effects"
    },
    "playcraft/systems/particles": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Particles"
    },
    "playcraft/systems/input": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Input"
    },
    "playcraft/systems/expiry": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Expiration"
    },
    "playcraft/systems/activation": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Activation"
    },
    "playcraft/systems/render": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Render"
    },
    "playcraft/systems/layout": {
      deps: ["playcraft/boot", "playcraft/systems/entitysystem"],
      exports: "pc.systems.Layout"
    }
  }
});
